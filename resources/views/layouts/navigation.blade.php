    ...
    <div class="fixed flex flex-col left-0 w-14 hover:w-64 md:w-64 overlay2 bg-gradient-to-r from-green-400 to-indigo-500 dark:bg-gray-900 h-full text-white transition-all duration-300 border-none z-10 sidebar">
        <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
          ...
          <li>
            ...
            <li>
              <x-nav-link :href="route('article.index')" :active="request()->routeIs('article.index', 'article.edit', 'article.create')" class="relative flex flex-row items-center h-11 text-center"><span class="text-white inline-flex justify-center items-center ml-4">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"></path></svg>
                </span>
                <span class="ml-2 text-2xl tracking-wide truncate text-white"> {{ __('article') }}</span>
              </x-nav-link>
            </li>
            <li>
              <x-nav-link :href="route('map.index')" :active="request()->routeIs('map.index', 'map.edit')" class="relative flex flex-row items-center h-11 text-center"><span class="text-white inline-flex justify-center items-center ml-4">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"></path></svg>
                </span>
                <span class="ml-2 text-2xl tracking-wide truncate text-white"> {{ __('map') }}</span>
              </x-nav-link>
            </li>
            <li>
              <x-nav-link class="relative flex flex-row items-center h-11 text-center"><span class="text-white inline-flex justify-center items-center ml-4">
                ...
                @csrf
                  ...
                  this.closest('form').submit();" class="ml-2 text-4xl tracking-wide truncate text-white">{{ __('Log Out') }}</span>
                </form>
              </x-nav-link>
            </li>
        </ul>
