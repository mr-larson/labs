                ...
                <div class="col-sm-offset-3 col-sm-6">
                    <div class="rounded overflow-hidden shadow-md py-14 flex flex-col justify-center align-center items-center overlay2 bg-purple-800">
                        ...
                        <div class="buttons flex justify-center">
                            @can('update', $adresse)
                                <a href="{{route('adresse.edit',$adresse->id) }}" class="bg-gradient-to-r from-green-400 to-purple-500 hover:bg-indigo-700 text-white px-2 rounded-lg m-2 w-auto text-center">Edit</a>
                            @endcan
                        </div>
                    </div>
                </div>
