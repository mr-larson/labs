                ...
                <div class="col col-sm-3 my-4">
                    <div class="rounded overflow-hidden shadow-lg p-14 flex flex-col justify-center align-center items-center overlay2 bg-purple-800">
                        <div class="text-center">   
                            ...
                            <p class="text-green-300 text-opacity-80 text-xl">{{ $testimonial->p }}</p>
                            <p class="text-white text-opacity-80">{{ $testimonial->p2 }}</p>
                            <div class="buttons flex justify-center">
                                @can('update', $testimonial)
                                    <a href="{{route('testimonial.edit',$testimonial->id) }}" class="hover:text-purple-300 bg-gradient-to-r from-green-400 to-purple-500 text-white  py-1 px-3 rounded-lg m-2 w-auto text-center">Edit</a>
                                @endcan
