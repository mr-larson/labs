                    ...
                    <div class="rounded w-96 overflow-hidden shadow-lg p-14 flex flex-col justify-center align-center items-center overlay2 bg-purple-800">
                        <div class="">
                            ...
                            <div class="buttons flex justify-center">
                                @can('update', $article)
                                    <a href="{{route('article.edit',$article->id) }}" class="bg-gradient-to-r from-green-400to-purple-500 hover:text-purple-300 text-white px-2 rounded-lg m-2 w-auto text-center">Edit</a>
                                @endcan
                                @can('delete', $article)
