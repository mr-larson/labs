        ...
        <section class="py-12">
            ...
            <div class="container">
                ...
                @foreach ($sliders as $slider)
                    <div class="rounded w-96 overflow-hidden shadow-lg p-14 flex flex-col justify-center align-center items-center overlay2 bg-purple-600 hover:bg-purple-800">
                        <div class="">
                            <h3 class="text-white">slider</h3>
                        </div>
                            <div class="py-6">
                                <img class="h-60" src="{{asset("img/" . $slider->img) }}" alt="img">
                            </div>
