    ...
    <x-app-layout>
        <section class="py-12">
            ...
            <div class="container">
                    ...
                    <div class="col col-sm-3 my-4">
                        <div class="rounded w-96 overflow-hidden shadow-lg p-14 flex flex-col justify-center align-center items-center overlay2 bg-purple-800">
                            ...
                            <div class="buttons flex justify-center">
                                @can('update', $slider)
                                    <a href="{{route('slider.edit',$slider->id) }}" class="bg-gradient-to-r from-green-400 to-purple-500 hover:text-purple-300 text-white py-1 px-4 rounded-lg m-2 w-auto text-center">Edit</a>
                                @endcan
                                @can('delete', $slider)
                ...
                @endforeach
                <div class="flex justify-center">{{ $sliders->links() }}</div>
            </div>
        </section>
    </x-app-layout>
@endsection