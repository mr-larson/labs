                    ...
                    <div class="rounded w-96 overflow-hidden shadow-lg p-14 flex flex-col justify-center align-center items-center overlay2 bg-purple-800">
                        <div class="">
                            ...
                            <div class="buttons flex justify-center">
                                @can('update', $slider)
                                    <a href="{{route('slider.edit',$slider->id) }}" class="bg-gradient-to-r from-green-400 to-purple-500 hover:bg-indigo-700 text-white px-2 rounded-lg m-2 w-auto text-center">Edit</a>
                                @endcan
                                @can('delete', $slider)
