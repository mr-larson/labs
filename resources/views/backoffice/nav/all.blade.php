                ...
                <div class="col col-sm-4 my-4">
                    <div class="rounded overflow-hidden shadow-lg p-14 flex flex-col justify-center align-center items-center overlay2 bg-purple-800">
                        <div class="text-center">
                            <h2 class="text-white text-opacity-80">{{ $nav->li }}</h2>
                            <div class="buttons flex justify-center">
                                @can('update', $nav)
                                    <a href="{{route('nav.edit',$nav->id) }}" class="bg-gradient-to-r from-green-400 to-purple-500 hover:text-purple-300 text-white px-2 rounded-lg m-2 w-auto text-center">Edit</a>
                                @endcan
                            </div>
                        </div>
                        </div>
