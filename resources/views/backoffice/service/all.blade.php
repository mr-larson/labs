...
@section('content')
    <x-app-layout>
        <section class="py-12">
                    ...
                    <div class="col col-sm-4 my-4">
                        <div class="rounded overflow-hidden shadow-lg py-14 flex flex-col justify-center align-center items-center overlay2 bg-purple-800">
                            ...
                            <div class="buttons flex justify-center">
                                @can('update', $service)
                                    <a href="{{route('service.edit',$service->id) }}" class="bg-gradient-to-r from-green-400 to-purple-500 hover:text-purple-300 text-white py-1 px-4 rounded-lg m-2 w-auto text-center">Edit</a>
                                @endcan
                                @can('delete', $service)
            ...
            <div class="flex justify-center">{{ $services->links() }}</div>
        </section>
    </x-app-layout>
@endsection