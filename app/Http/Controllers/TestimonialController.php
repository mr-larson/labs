...
class TestimonialController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $testimonial->h2 = $request->h2;
        $testimonial->p2 = $request->p2;
        ...
        return redirect()->route('testimonial.index', compact('testimonial'))->with("message", "$testimonial->h2 a bien été crée.");
    }
